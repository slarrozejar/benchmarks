...
def test_nochange():
    os.system('./../dotLabel/dotLabel.py graph.dot > test.dot 2>/dev/null')
...
def test_node():
    os.system('./../dotLabel/dotLabel.py -n label="%color%" graph.dot > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
...
def test_edge():
    os.system('./../dotLabel/dotLabel.py -e label="%color%" graph.dot > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
...
def test_nofile_node():
    os.system('cat graph.dot | ./../dotLabel/dotLabel.py -n label="%color%" "-" > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
    result = pgv.AGraph("test_node.dot")
    if(test == result):
...
def test_nofile_edge():
    os.system('cat graph.dot | ./../dotLabel/dotLabel.py -e label="%color%" "-" > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
    result = pgv.AGraph("test_edge.dot")
    if(test == result):
...
def test_format_string():
    os.system('./../dotLabel/dotLabel.py graph.dot -n label="%color%(%b%), %b%%s%" -e label="%color%(%b%), %b%%s%" > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
...
def test_inversion():
    os.system('./../dotLabel/dotLabel.py graph.dot -n a="%b%" -n b="%a%" -e a="%b%" -e b="%a%" > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
...
def test_multiple_nodes():
    os.system('./../dotLabel/dotLabel.py graph.dot -n a=dog -n b=cat > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
...
def test_multiple_edges():
    os.system('./../dotLabel/dotLabel.py graph.dot -e a=dog -e b=cat > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
