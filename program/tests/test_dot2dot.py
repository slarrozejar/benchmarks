...
def test_node_label():
    os.system('(./../dot2dot/dot2dot.py graph.dot -n "" label="%color%") > test.dot 2>/dev/null')
...
def test_edge_label():
    os.system('(./../dot2dot/dot2dot.py graph.dot -e "" label="%color%") > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
...
def test_line_node():
    os.system('(./../dot2dot/dot2dot.py graph.dot -n "b=3&&a=4" color=yellow) > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
...
def test_line_edge():
    os.system('(./../dot2dot/dot2dot.py graph.dot -e "b=1" color=yellow) > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
...
def test_line_graph():
    os.system('(./../dot2dot/dot2dot.py graph.dot -g label="Name of the graph" font="Helvetica") > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
...
def test_line_multiple_nodes():
    os.system('(./../dot2dot/dot2dot.py graph.dot -n "b=3&&a=4" color=yellow -n label=n3 color=blue) > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
...
def test_file():
    os.system('(./../dot2dot/dot2dot.py graph.dot -s test.json) > test.dot 2>/dev/null')
    test = pgv.AGraph("test.dot")
...
def test_node_bad_condition():
    os.system('(./../dot2dot/dot2dot.py graph.dot -n "=blabla" color=blue) > test 2>/dev/null')
    res = open("test","r")
    content = res.read()
...
def test_edge_bad_condition():
    os.system('(./../dot2dot/dot2dot.py graph.dot -e "=blabla" color=blue) > test 2>/dev/null')
    res = open("test","r")
    content = res.read()
    if(content == "Condition with empty arguments\n"):
...
def test_file_bad_condition():
    os.system('(./../dot2dot/dot2dot.py graph.dot -s test_bad_condition.json) > test 2>/dev/null')
    res = open("test","r")
    content = res.read()
    if(content == "Condition with empty arguments\n"):
...
def test_and():
    os.system("""(./../dot2dot/dot2dot.py graph.dot -n "label='n3&&n2'&&a=toto" color=aquamarine) > test.dot 2>/dev/null""")
    test = pgv.AGraph("test.dot")
...
def test_bad_spaces():
    os.system('(./../dot2dot/dot2dot.py graph.dot -n "a=le vent e lève&&b=3") > test 2>/dev/null')
    res = open("test","r")
    content = res.read()
...
def test_no_condition_line():
    os.system("""(./../dot2dot/dot2dot.py graph.dot -n "" color=red -e "" color=blue) > test.dot 2>/dev/null""")
    test = pgv.AGraph("test.dot")
...
def test_no_condition_file():
    os.system("""(./../dot2dot/dot2dot.py graph.dot -s test_no_condition.json) > test.dot 2>/dev/null""")
    test = pgv.AGraph("test.dot")
    result = pgv.AGraph("test_no_condition.dot")
    if(test == result):
