...
<label kind='assignment'>S${i}_IntStat := 0, S${i}_z := 0$aff1</label>
</transition>"
    fi
    echo "<transition>
<source ref='id$ID'/>
...
<source ref='id$(($ID+1))'/>
<target ref='id$(($ID+1))'/>
<label kind='guard'>S${i}_IntStat == 0 &amp;&amp; S${i}_z &gt; 0 $cond</label>
<label kind='assignment'>polled_S${i}_grant := Ctrl_grant$i, S${i}_IntStat := 1$add $aff1</label>
</transition>
<transition>
<source ref='id$(($ID+2))'/>
<target ref='id$(($ID+2))'/>
...
<label kind='assignment'>S${i}_Safe := 1, S${i}_IntStat := 0, S${i}_z := 0 $aff2</label>
</transition>"
    if [ ${R[$i]} -eq 1 ]; then
...
<label kind='assignment'>S${i}_Safe := 0, S${i}_IntStat := 0, S${i}_z := 0 $aff2</label>
</transition>"
    if [ ${R[$i]} -eq 1 ]; then
...
<label kind='assignment'>Ctrl_IntStat := 0, Ctrl_z := 0 $aff</label>
</transition>
<transition>
<source ref='id$(($ID+1))'/>
<target ref='id$(($ID+1))'/>
...
<source ref='id$(($ID+1))'/>
<target ref='id$(($ID+1))'/>
<label kind='guard'>Ctrl_IntStat == 0 &amp;&amp; Ctrl_z &gt; 0 $cond</label>
<label kind='assignment'>polled_Ctrl_Safe1 := S1_Safe, polled_Ctrl_Safe2 := S2_Safe, Ctrl_IntStat := 1 $aff</label>
</transition>
<transition>
<source ref='id$(($ID+2))'/>
<target ref='id$(($ID+2))'/>
...
<target ref='id$(($ID+2))'/>
<label kind='guard'>Ctrl_IntStat == 1 &amp;&amp; polled_Ctrl_Safe2 == 1 &amp;&amp; Ctrl_grant1 == 0 &amp;&amp; Ctrl_y0 &gt;= 2000</label>
<label kind='assignment'>Ctrl_grant1 := 1, Ctrl_IntStat := 0, Ctrl_z := 0, Ctrl_y0 := 0 $aff</label>
</transition>
<transition>
<source ref='id$(($ID+2))'/>
<target ref='id$(($ID+3))'/>
<label kind='guard'>Ctrl_IntStat == 1 &amp;&amp; polled_Ctrl_Safe1 == 0 &amp;&amp; Ctrl_grant1 == 1</label>
<label kind='assignment'>Ctrl_grant1 := 0, Ctrl_IntStat := 0, Ctrl_z := 0, Ctrl_y0 := 0 $aff</label>
</transition>
<transition>
<source ref='id$(($ID+2))'/>
<target ref='id$(($ID+3))'/>
...
<target ref='id$(($ID+4))'/>
<label kind='guard'>Ctrl_IntStat == 1 &amp;&amp; polled_Ctrl_Safe1 == 1 &amp;&amp; Ctrl_grant2 == 0 &amp;&amp; Ctrl_y0 &gt;= 2000</label>
<label kind='assignment'>Ctrl_grant2 := 1, Ctrl_IntStat := 0, Ctrl_z := 0, Ctrl_y0 := 0 $aff</label>
</transition>
<transition>
<source ref='id$(($ID+4))'/>
<target ref='id$(($ID+1))'/>
<label kind='guard'>Ctrl_IntStat == 1 &amp;&amp; polled_Ctrl_Safe2 == 0 &amp;&amp; Ctrl_grant2 == 1</label>
<label kind='assignment'>Ctrl_grant2 := 0, Ctrl_IntStat := 0, Ctrl_z := 0, Ctrl_y0 := 0 $aff</label>
</transition>
<transition>
<source ref='id$(($ID+4))'/>
<target ref='id$(($ID+1))'/>
